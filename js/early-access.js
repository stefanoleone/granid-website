// Granid — Early Access Program form submit handler (GWEB-94)
// Posts to the CRM /leads endpoint with tier_interest="early_access".
// Same contract as js/trial.js; the CRM-side discriminator branch is
// tracked in a GCRM ticket and must land before this form goes live.
...
(function () {
  ...
  var I18N = {
    en: {
      personal_email_domain: 'Please use a company email address. Personal email providers like gmail.com or hotmail.com are not eligible for the program.',
      already_trialed: 'Your firm has already used a trial or Early Access license. Visit our contact page to discuss a license.',
      resubmission_locked: 'A request is already pending for your firm. Please check your inbox for the activation link before requesting again.',
      ...
      submitting: 'Sending…',
      sentPath: '/early-access-sent/'
    },
    de: {
      personal_email_domain: 'Bitte verwenden Sie eine geschäftliche E-Mail-Adresse. Persönliche E-Mail-Anbieter wie gmail.com oder hotmail.com sind für das Programm nicht zulässig.',
      already_trialed: 'Ihre Kanzlei hat bereits einen Trial oder eine Early-Access-Lizenz eingelöst. Besuchen Sie unsere Kontaktseite für eine Lizenz.',
      resubmission_locked: 'Eine Anfrage für Ihre Kanzlei ist bereits ausstehend. Bitte prüfen Sie Ihren Posteingang auf den Aktivierungslink, bevor Sie erneut anfragen.',
      ...
      sentPath: '/de/early-access-sent/'
    },
    fr: {
      personal_email_domain: 'Veuillez utiliser une adresse e-mail professionnelle. Les fournisseurs personnels comme gmail.com ou hotmail.com ne sont pas éligibles pour le programme.',
      already_trialed: 'Votre étude a déjà bénéficié d’un essai ou d’une licence Early Access. Consultez notre page de contact pour discuter d’une licence.',
      resubmission_locked: 'Une demande est déjà en attente pour votre étude. Veuillez vérifier votre boîte de réception pour le lien d’activation avant de soumettre à nouveau.',
      ...
      submitting: 'Envoi…',
      sentPath: '/fr/early-access-sent/'
    },
    it: {
      personal_email_domain: 'Usi un indirizzo email aziendale. I provider personali come gmail.com o hotmail.com non sono ammessi per il programma.',
      already_trialed: 'Il suo studio ha già usato una prova o una licenza Early Access. Visiti la pagina dei contatti per una licenza.',
      resubmission_locked: 'Una richiesta è già in attesa per il suo studio. Controlli la sua casella di posta per il link di attivazione prima di inviare di nuovo.',
  ...
  var globalErrorEl = document.getElementById('early-access-error-global');
  ...
  function submit(data, btn) {
    ...
    fetch(CRM_ENDPOINT, {
      ...
      if (res.ok) {
        window.location.href = messages.sentPath;
        return;
      }
